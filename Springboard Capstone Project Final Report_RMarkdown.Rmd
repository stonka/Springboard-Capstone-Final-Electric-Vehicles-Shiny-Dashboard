...
- OPPORTUNITIES -- Data collection:
  1. Improve updating the station validation status.  There are about 70k entries in this dataset. Only about 2% of that are
...
- OPPORTUNITIES -- Statistical analysis:
  1. Including a population census data, proximity of stations to the highway systems, electric vehicle sales data, or alternative
     ...
     in-depth statistical [predictive) modeling.  
...
- OPPORTUNITIES -- RShiny Dashboard:
  ...
  2. Alter data set to display country names, or include slicer-like widget to allow the user to filetr for a set of counries.  A
...
- I did other data wrangling (i.e. variable value replacement for 'UsageTypeID') as needed.

3. DATA VISUALIZATION & STORYTELLING
- I made sure that some of the summary dashboard boxes display expected summary data formatting (i.e comma in thousands, %).
...
I concluded that:
- There are, generally speaking, weak relationships among most of the 21 variables in my final raw data.
...
V. DELIVERABLES
1. Code for a) data access and b) ShinyApp: completed and available at: https://github.com/stonka/Springboard-Capstone-Final-Electric-Vehicles-Shiny-Dashboard 
2. Paper/final summary of the Capstone Project: completed and avaiable in my 1st Markdown document at: https://github.com/stonka/Springboard-Capstone-Final-Electric-Vehicles-Shiny-Dashboard 
3. Slide deck of the Capstone Project Summary: completed and available at: https://github.com/stonka/Springboard-Capstone-Final-Electric-Vehicles-Shiny-Dashboard 
